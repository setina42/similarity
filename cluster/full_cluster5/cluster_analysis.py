...
def run_sim_single(name,id,img_path,exclude = None):
   #print(name)
   #print(id)
   base_path = "/home/gentoo/src/similarity/cluster/full_cluster5/single_gene_results/"
...
input_components = [69262234,70919382,79587720,70634395,69529059,74562284]
...
while not done:
   ...
   print("while")
   print(i)
   res_top_hit_path = run_sim_single(name,id,path,exclude=exclude)

...
all = [abi,mean,max,MI_exp,GC_exp,pears,pears_raw,MI_exp_raw_no_mask,MI_exp_raw_mask,MS_exp ]
names = ["abi","mean","max","MI_exp","GC_exp","pears","pears_raw","MI_exp_raw_no_mask","MI_exp_raw_mask ", "MS_exp"]
...
for j in range(1,len(all)):
       ...
       name = "abi" + " vs " + names[j]
       print("comparing: " + "abi" + " and "  + names[j])
       print("----------------------------------------------")

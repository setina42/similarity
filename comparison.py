...
#for count in [10,15,20,25,30,50,80,100,150,200,2000]:
...
#Znfx1
   ...
   all = [experiment,mean,max,abi,MI_exp,GC_exp,MS_exp,pears,pears_raw,MI_exp_raw_no_mask]
   names = ["experiment","mean","max","abi","MI_exp","GC_exp","MS_exp","pears","pears_raw","MI_exp_raw_no_mask"]
